...
namespace GeometryBasics.Models
{
    ...
    3. Стената е видима ако проекциите върху нормалата на стената на перспективния проекционнен вектор и на вектор сочещ към вътрешността на многостена са еднопосочни.
