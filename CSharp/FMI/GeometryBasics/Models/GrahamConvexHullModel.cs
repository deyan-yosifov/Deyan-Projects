...
namespace GeometryBasics.Models
{
    ...
    1. Избира екстремална точка от множеството (например най-долната, най-вляво).
    2. Сортира другите точки по ъгъл на предшествие спрямо избраната екстремална точка.
